  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '使用指南', link: '/guide/comic-server-guide' },
      {
        text: '站点链接',
        items: [
          { text: '主站', link: 'https://startrekcn.cn' },
          { text: '视频站', link: 'https://video.startrekcn.cn' },
    ...
    '/docs/': [
      {
        text: '下一代技术手册',
        items: [
          { text: '目录', link: '/docs/tng-technical-manual/' },
